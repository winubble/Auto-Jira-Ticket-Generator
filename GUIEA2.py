...
e1 = tk.Entry(log_inWindow, font = "bold", bg = "white", fg = "black", cursor = "heart", insertbackground = 'white')
e2 = tk.Entry(log_inWindow, show = '*', font = "bold", bg = "white", fg = "black", cursor = "heart", insertbackground = 'white')
...
tk.Button(log_inWindow, text = 'Log In', font = "bold", command = save_textvariable, bd = 4, width = 8, bg = "#0E69C1", fg = "white", activeforeground = "gray").grid(row = 2, column = 2, padx = 10,)
...
def EandA():
    ...
    try:
        ...
        Label(labelframe1, text = "Deploy.xlsx successfully generated.", font = fontStyle, background = "#0E69C1", foreground = "white").place(x = 20, y = 100)
        tk.Button(labelframe1, text = "EXIT", command = quit_initWindow, font = 'bold', bd = 4, width = 10, bg = "white", fg = "black", activeforeground = "gray").place(x = 350, y = 175)
    except:
        Label(labelframe1, text = "Fail to generate Deploy.xlsx", font = fontStyle, background = "#0E69C1", foreground = "white").place(x = 20, y = 100)
        tk.Button(labelframe1, text = "EXIT", command = quit_initWindow, font = 'bold', bd = 4, width = 10, bg = "white", fg = "black", activeforeground = "gray").place(x = 350, y = 175)
...
tk.Button(labelframe1, text = "ENTER", command = EandA, font = 'bold', bd = 4, width = 10, bg = "white", fg = "black", activeforeground = "gray").place(x = 350, y = 100)
